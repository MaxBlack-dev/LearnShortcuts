...
/**
 * Application-level persistent settings for ShortcutSensei.
 * Stored in {@code ShortcutSenseiSettings.xml} inside the IDE config directory.
 */
@State(
    name = "ShortcutSenseiSettings",
    storages = [Storage("ShortcutSenseiSettings.xml")],
)
