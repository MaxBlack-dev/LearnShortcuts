...
import dev.maxblack.learnshortcuts.core.model.Statistics

/**
 * Application-level persistent statistics for LearnShortcuts.
 * Stored in {@code LearnShortcutsStatistics.xml} inside the IDE config directory.
 *
 * All counters survive IDE restarts and accumulate across multiple sessions.
 */
@State(
    name = "LearnShortcutsStatistics",
    storages = [Storage("LearnShortcutsStatistics.xml")],
)
